    ...
    var uploader = new plupload.Uploader({
        ...
        init: {
            PostInit: function () {
                ...
                (new Image()).src = '/st/img/loaders/circle.gif';
                (new Image()).src = '/st/img/loaders/input-loader.gif';
            ...
            BeforeUpload: function (up, file) {
                ...
                blockNewCommentEdit(function () {
                    $('.b-new-message-box__attach').append('<div class="b-new-message-box__attach-item" data-type="loader"><img src="/st/img/loaders/circle.gif" /></div>');
                });
