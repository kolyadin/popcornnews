...
<?
  ...
  case(102): 
    ...
    while($s=mysql_fetch_array($line))
    {
      ...
      if ($qname) mysql_query("UPDATE $tbl_goods_ SET name='$qname',pole2='$qpole2',pole3='$qpole3',pole4='$qpole4',pole5='$qpole5',pole6='$qpole6',pole7='$qpole7',pole8='$qpole8',pole9='$qpole9',pole10='$qpole10',pole11='$qpole11',pole15='$qpole15' WHERE page_id=$page_id AND goods_id=$questions_goodsid AND id=$qid)",$link);
      $flag=1;
    }
