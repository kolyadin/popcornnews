...
define ('remote_file', '/news2kinoafisha.txt');

// db options
define ('db_tmp_file', '/tmp/news2kinoafisha.txt');
define ('db_socket', '/tmp/mysql-kino.sock');
define ('db_user', 'azat');
define ('db_pass', 'Juhodav7');
define ('db_port', '3308');
define ('db_name', 'popcornnews');
define ('db_condition', 'SELECT * FROM popconnews_goods_ WHERE goods_id = 2 AND page_id = 2');
