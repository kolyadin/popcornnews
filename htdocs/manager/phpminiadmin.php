...
require_once $_SERVER['DOCUMENT_ROOT'] . '/data/libs/config.lib.php';
 $ACCESS_PWD='pass1313'; #script access password, SET IT if you want to protect script from public access

 #DEFAULT db connection settings
 $DB=array(
 'user'=>DB_LOGIN,#required
 'pwd'=>DB_PASS, #required
 'db'=>DB_NAME,  #default DB, optional
