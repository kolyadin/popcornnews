...
<div id="contentWrapper" class="twoCols">
	<div id="content">
		...
		<table class="contentUsersTable">
			...
			$num_users = $p['query']->get_num('person_fans', array('gid'=>$d['person']['id'], 'city_id'=>$d['city_id']));
			$pages = ceil($num_users / $limit);
			foreach ($p['query']->get('person_fans', array('gid'=>$d['person']['id'], 'city_id'=>$d['city_id']), array($d['sort']), $offset, $limit) as $i => $user) {
