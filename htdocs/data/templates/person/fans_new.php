<?
$this->_render('inc_header', array('title'=>'Новые поклонники - ' . $d['person']['name'], 
...
<div id="contentWrapper" class="twoCols">
	<div id="content">
		...
		<ul class="menu bLevel">
			...
			<li class="active"><a href="/persons/<?=$handler->Name2URL($d['person']['eng_name']);?>/fans/new">новые</a></li>
			<?
		...
		<h2>Новые поклонники <?=$d['person']['genitive']?></h2>
		<table class="contentUsersTable">
			...
			<?foreach ($p['query']->get('person_fans', array('gid'=>$d['person']['id']), array('id desc'), 0, 20) as $i => $user) {
