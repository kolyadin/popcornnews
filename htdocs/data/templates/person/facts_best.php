<?
$this->_render('inc_header', array('title'=>'Лучшие факты - ' . $d['person']['name'], 
...
<div id="contentWrapper" class="twoCols">
	<div id="content">
		...
		<ul class="menu bLevel">
			...
			<li class="active"><a href="/persons/<?=$handler->Name2URL($d['person']['eng_name']);?>/facts/best">архив лучших</a></li>
			<?if (!$d['person']['no_adding_facts']) {?><li><a href="/persons/<?=$handler->Name2URL($d['person']['eng_name']);?>/facts/post">прислать факт</a></li><?}?>
		</ul>
		<h2>Лучшие факты <?=$d['person']['genitive']?></h2>
