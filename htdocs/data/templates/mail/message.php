...
<div style="padding: 20px">
	...
	<h2 style="font: 24px 'Trebuchet MS', Tahoma, Verdana, Arial; margin-top: 15px; margin-bottom: 10px;"><?=$d['title']?></h2>
	<div style="background: #e5e5e5; padding: 12px 15px;">
		<span style="font: 13px Tahoma, Verdana, Arial; display: block; margin-bottom: 12px;"><?=$d['message']?></span>
