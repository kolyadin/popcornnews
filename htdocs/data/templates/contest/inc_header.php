	...
	<body>
		<div class="contest-menu">
			...
			<ul>
				...
				<li<?=($d['rewrite'][1] == 'rules' ? ' class="active"' : null)?>><a href="/contest/rules">Правила</a></li>
				<li<?=($d['rewrite'][1] == 'works' || $d['rewrite'][1] == 'work' ? ' class="active"' : null)?>><a href="/contest/works">Работы</a></li>
				<?/*<li class="takePart<?=($d['rewrite'][1] == 'take_part' ? ' active' : null)?>"><a class="takePart" href="/contest/take_part">принять участие</a></li>*/?>
			</ul>
			<!-- \menu -->
		</div>
...
?>
			<ul class="menu">
				...
				<li><noindex><a rel="nofollow" href="http://vkontakte.ru/club10361506" target="_blank"><img src="/i/vkontakte_logo.png" alt="popcornnews.ru ВКонтакте"/></a></noindex></li>
			</ul>