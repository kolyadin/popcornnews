...
// +----------------------------------------------------------------------+
//
// $Id: Links.php,v 1.9 2007/06/05 20:54:42 dufuz Exp $
//
...
class HTML_BBCodeParser_Filter_Links extends HTML_BBCodeParser
{
     ...
     * @var     array
     */
    public $_allowedSchemes = array('http', 'https', 'ftp');
    ...
    public $_definedTags = array(
        'url' => array(
            ...
            'htmlclose' => 'a',
            'allowed'   => 'none^img',
            'attributes'=> array('url' => 'target="_blank" href=%2$s%1$s%2$s')
        )
    );
